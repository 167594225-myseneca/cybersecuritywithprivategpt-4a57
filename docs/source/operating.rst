...
Generated On: 2024-12-03 14:25:47 UTC
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39757  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='167594225-myseneca'  \-\-env DOCKERUSERNAME='jona.lyn.learning@gmail.com'  \-\-env MQTTUSERNAME='jonalyn'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   jona.lyn.learning@gmail.com/cybersecuritywithprivategpt-4a57-amd64 (https://hub.docker.com/r/jona.lyn.learning@gmail.com/cybersecuritywithprivategpt-4a57-amd64)
...
.. code-block::
   ...
   docker run -d -p 44969:44969 -p 48715:48715 -p 39625:39625 -p 8883:8883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=44969 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=48715  \
          --env SOLUTIONVIPERVIZPORT=39625 \
          --env DOCKERUSERNAME='jona.lyn.learning@gmail.com' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=39757 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          --env MQTTUSERNAME='jonalyn' \
          --env AIRFLOWPORT=9000  \
          --env GITPASSWORD='<Enter Github Password>' \
          --env KAFKACLOUDPASSWORD='<Enter API secret>' \
          --env MQTTPASSWORD='<Enter mqtt password>' \
          --env READTHEDOCS='<Enter Readthedocs token>' \
          jona.lyn.learning@gmail.com/cybersecuritywithprivategpt-4a57-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=44969, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38447, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=40461, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38191, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42013, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44535, HPDEHOST=127.0.1.1, HPDEPORT=36357, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43841

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6776-cybersecuritywithprivategpt-4a57,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57, python-preprocess-9285-cybersecuritywithprivategpt-4a57,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57, python-ai-275-cybersecuritywithprivategpt-4a57,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
