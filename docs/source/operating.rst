[cybersecuritywithprivategpt-4a57] Operating Details
====================================

Generated On: 2024-11-14 17:58:53 UTC
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-4a57] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-4a57] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35545  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='167594225-myseneca'  \-\-env DOCKERUSERNAME='xXjona18Xx'  \-\-env MQTTUSERNAME='xXjonaXx'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   xXjona18Xx/cybersecuritywithprivategpt-4a57-amd64 (https://hub.docker.com/r/xXjona18Xx/cybersecuritywithprivategpt-4a57-amd64)
...
.. important::
   docker run -d -p 58753:58753 -p 45881:45881 -p 56351:56351 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-4a57 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57 \-\-env GITUSERNAME=167594225-myseneca  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=58753  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=45881  \-\-env SOLUTIONVIPERVIZPORT=56351 \-\-env DOCKERUSERNAME='xXjona18Xx' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=35545 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='xXjonaXx' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  xXjona18Xx/cybersecuritywithprivategpt-4a57-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - xXjona18Xx/cybersecuritywithprivategpt-4a57-amd64
...
[cybersecuritywithprivategpt-4a57] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/167594225-myseneca/cyt160-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-4a57
...
.. important::
   https://cybersecuritywithprivategpt-4a57.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=58753, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43011, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43995, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43889, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42619, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45501, HPDEHOST=127.0.1.1, HPDEPORT=37649, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46373

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8227-cybersecuritywithprivategpt-4a57,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57, python-preprocess-9930-cybersecuritywithprivategpt-4a57,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57, python-ai-9197-cybersecuritywithprivategpt-4a57,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-4a57, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
